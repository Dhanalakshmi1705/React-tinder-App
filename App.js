...
const images = [
  { id: 1, url: require('./assets/profiles/7.jpg') },
  { id: 2, url: require('./assets/profiles/2.jpg') },
  { id: 3, url: require('./assets/profiles/3.jpg') },
  { id: 4, url: require('./assets/profiles/4.jpg') },
  { id: 5, url: require('./assets/profiles/1.jpg') }
]
...
export default class App extends React.Component {
  ...
  render() {
    return (
      <View style={{ flex: 1 }}><Text style={{fontSize: 20}}>My Tinder App</Text>
